...
|---|---|---|---|---|
| 1 | OceanBase | 未实现 | 小 | 增加 flavor 识别、版本展示、MySQL 兼容连接探测、基础标签展示 |
| 2 | TiDB | 部分实现 | 小 | 已有 flavor 识别；补齐版本目录、拓扑展示、部署/接入边界说明 |
| 3 | GaussDB(for MySQL) | 未实现 | 小到中 | 按 MySQL 兼容数据库接入；补云托管/自建差异、只读部署限制 |
